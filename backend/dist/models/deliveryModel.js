...
const deliveryShema = new mongoose_1.Schema({
    orderId: { type: mongoose_1.Schema.Types.ObjectId, required: true },
    seller: { type: mongoose_1.Schema.Types.ObjectId, required: true },
...
const Delivery = mongoose_1.default.model("Deliver", deliveryShema);
